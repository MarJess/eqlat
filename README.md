# eqlat — Equivalent Latitude Computation
...
| Notebook | Content |
|---|---|
| `notebooks/01_eqlat_reanalysis_comparison.ipynb` | Compare piecewise vs. ROI method using ERA5 / MERRA-2 |
| `notebooks/02_eqlat_profile_analysis.ipynb` | Analyse equivalent latitude profiles |
...
│   └── process_fields.py
└── notebooks/
    ├── 01_eqlat_reanalysis_comparison.ipynb
    └── 02_eqlat_profile_analysis.ipynb
```
